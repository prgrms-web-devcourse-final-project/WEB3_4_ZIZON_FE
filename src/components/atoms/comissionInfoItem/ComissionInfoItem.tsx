interface ComissionInfoItemProps {
  label: '마감일' | '근무지' | '예산';
  content: Date | string | number;
}

function formatContent(
  label: ComissionInfoItemProps['label'],
  content: ComissionInfoItemProps['content'],
): string {
  switch (label) {
    case '마감일':
...
function ComissionInfoItem({ label, content }: ComissionInfoItemProps) {
...
export default ComissionInfoItem;
