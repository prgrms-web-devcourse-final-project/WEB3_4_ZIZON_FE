...
export default function CommonEndStepTemplate({id1, id2, id3, value1, value2, value3, onChange1, onChange2, onChange3, onClickNext, onClickBefore}: CommonEndStepTemplateProps) {
  return (
