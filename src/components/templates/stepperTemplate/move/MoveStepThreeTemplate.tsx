...
export default function MoveStepThreeTemplate({id1, id2, id3, value1, value2, value3, onChange1, onChange2, onChange3, checkSelectBoxProps, onClickBefore, onClickNext}: MoveStepThreeTemplateProps) {
  return (
    <div className='px-230 bg-black2'>
      <h1 className="text-24 font-semibold pt-78 mb-28">견적 요청서를 작성하는 중이에요</h1>
      <CommissionTopBox title={'4.출발지 정보'} progressStep={3} isBefore={true} onClickBefore={onClickBefore} />
