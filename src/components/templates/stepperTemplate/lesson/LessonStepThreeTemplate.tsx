...
export default function LessonStepThreeTemplate({selectedOptionListProps, checkSelectBoxProps1, checkSelectBoxProps2, onClickBefore, onClickNext}: LessonStepThreeTemplateProps) {
  return (
