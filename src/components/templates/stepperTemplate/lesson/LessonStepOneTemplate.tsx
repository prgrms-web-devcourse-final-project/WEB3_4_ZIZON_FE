...
export default function LessonStepOneTemplate({checkSelectBoxProps1, checkSelectBoxProps2, onClickBefore, onClickNext }: LessonStepOneTemplateProps) {
  return (
    <div className='px-230 bg-black2'>
      <h1 className="text-24 font-semibold pt-78 mb-28">견적 요청서를 작성하는 중이에요</h1>
      <CommissionTopBox title={'2.과외 정보'} progressStep={2} isBefore={true} onClickBefore={onClickBefore} />
